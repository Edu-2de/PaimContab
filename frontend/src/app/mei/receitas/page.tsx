...
function ReceitasContent() {
  ...
  const receitasRecebidas = filteredReceitas.filter(r => r.status === 'Recebido').reduce((sum, receita) => sum + receita.value, 0);
  const receitasPendentes = filteredReceitas.filter(r => r.status === 'Pendente').reduce((sum, receita) => sum + receita.value, 0);
            ...
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-slate-600 mt-1 text-sm">
                  Controle e gerencie todas as suas receitas
                </p>
              </div>
              <button
